...
export AZURE_STORAGE_SAS_TOKEN=`az storage container generate-sas --connection-string ${AZURE_STORAGE_CONNECTION_STRING} -n ${container_name} --permissions dlrw --expiry '2019-05-30' --output tsv`
